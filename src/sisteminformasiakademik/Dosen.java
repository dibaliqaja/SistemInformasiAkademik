...
public class Dosen extends javax.swing.JFrame {
    ...
    public Dosen() throws SQLException {
        ...
        String []judul = {"NO","ID","NAMA","NIP","TMPT LAHIR","TGL LAHIR","JNS KELAMIN","AGAMA","NO. HP","EMAIL","ALAMAT","PRODI"};
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(kGradientPanel1, javax.swing.GroupLayout.DEFAULT_SIZE, 2060, Short.MAX_VALUE)
        );
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        try {
            ...
            if(i>-1){
                ...
                jComboBox1.setSelectedItem(model.getValueAt(i, 11).toString());
            }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
        try {
            String sql = "DELETE FROM `dosen` WHERE `dosen`.`id_dosen` = '"+jTextField4.getText()+"'";
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            SimpleDateFormat waktu = new SimpleDateFormat("yyyy-MM-dd");
            String sql = "UPDATE `dosen` SET `nama` = '"+jTextField1.getText()+"', `nip` = '"+jTextField2.getText()+"', `tempat_lahir` = '"+jTextField3.getText()+"', `tanggal_lahir` = '"+String.valueOf(waktu.format(jDateChooser1.getDate()))+"', `jk` = '"+jComboBox2.getSelectedItem()+"', `agama` = '"+jTextField5.getText()+"', `nohp` = '"+jTextField6.getText()+"', `email` = '"+jTextField7.getText()+"', `alamat` = '"+jTextArea1.getText()+"', `nama_prodi` = '"+jComboBox1.getSelectedItem()+"' WHERE `dosen`.`id_dosen` = '"+jTextField4.getText()+"'";
            st = con.createStatement();
            st.executeUpdate(sql);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            SimpleDateFormat waktu = new SimpleDateFormat("yyyy-MM-dd");
            String sql = "INSERT INTO `dosen` (`id_dosen`, `nama`, `nip`, `tempat_lahir`, `tanggal_lahir`, `jk`, `agama`, `nohp`, `email`, `alamat`, `nama_prodi`) VALUES (NULL, '"+jTextField1.getText()+"', '"+jTextField2.getText()+"', '"+jTextField3.getText()+"', '"+String.valueOf(waktu.format(jDateChooser1.getDate()))+"', '"+jComboBox2.getSelectedItem()+"', '"+jTextField5.getText()+"', '"+jTextField7.getText()+"', '"+jTextField6.getText()+"', '"+jTextArea1.getText()+"', '"+jComboBox1.getSelectedItem()+"')";
            st = con.createStatement();
            st.executeUpdate(sql);
    ...
    public void tampil() throws SQLException {
        ...
        for(int a=0;a<row;a++){
            ...
            ResultSet rs = cn.createStatement().executeQuery("SELECT * FROM dosen");
            int no=0;
            while(rs.next()){
                no++;
